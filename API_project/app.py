...
if selected_menu == "Dashboard":
    ...
    if st.button("Add Recipe", key="add_recipe_button"):
        if all([recipe_name, recipe_description, recipe_ingredients, recipe_instructions, recipe_cuisine,
            ...
            create_recipe(recipe_name, recipe_description, recipe_ingredients, recipe_instructions,
    ...
    if category_list:
        ...
        if manage_action == "Edit":
            ...
            if category_to_edit:
                ...
                new_name = st.text_input("Category Name", value=selected_category['name'], key="edit_category_name")

                if st.button("Update Category", key="update_category_button"):
                    if new_name:
                        update_category(selected_category['id'], new_name)
